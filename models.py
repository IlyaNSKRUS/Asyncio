...
class SwapiPeople(Base):
    ...
    films: Mapped[list[str]] = mapped_column(String, nullable=True)
    species: Mapped[list[str]] = mapped_column(String, nullable=True)
    vehicles: Mapped[list[str]] = mapped_column(String, nullable=True)
    starships: Mapped[list[str]] = mapped_column(String, nullable=True)
